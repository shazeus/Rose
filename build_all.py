...
# -*- coding: utf-8 -*-
"""
Complete build script for Aurelia
...
def run_create_installer():
    ...
    installer_files = list(installer_dir.glob("Aurelia_Setup*.exe"))
...
def build_all():
    ...
    print_header("Aurelia - Complete Build Process")
    ...
    if not run_build_exe():
        ...
        print("   pip install -r requirements.txt")
        print("2. Close any running instances of Aurelia.exe")
    ...
    if not run_create_installer():
        ...
        print("  dist/Aurelia/Aurelia.exe")
    ...
    exe_path = Path("dist/Aurelia/Aurelia.exe")
    installer_files = list(Path("installer").glob("Aurelia_Setup*.exe"))
    ...
    print("    Run: dist\\Aurelia\\Aurelia.exe")
    print()
    print("  • For distribution:")
    print(f"    Share: {installer_path if installer_path else 'installer/Aurelia_Setup.exe'}")
    print()
    print("  • For portable version:")
    print("    Zip: dist\\Aurelia\\ folder")
...
def main():
    ...
    if not Path("main.py").exists():
        ...
        print("Please run this script from the Aurelia root directory.")
        sys.exit(1)
