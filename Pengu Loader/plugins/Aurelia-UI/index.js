...
(function enableLockedSkinPreview() {
  ...
  // TODO Preferably move bridge communication logic and websocket interception to a separate Pengu plugin like AURELIA-CORE,
  ...
  const INLINE_RULES = `
    ...
    .skin-selection-carousel .skin-selection-item .lpp-skin-border {
      ...
      border-image-source: linear-gradient(0deg, #a333ff 0%, #00f2ff 50%, #ffffff 100%);
    ...
    .skin-selection-carousel .skin-selection-item.skin-carousel-offset-2 .lpp-skin-border {
      border: 2px solid transparent;
      border-image-source: linear-gradient(0deg, #a333ff 0%, #00f2ff 44%, #00f2ff 59%, #a333ff 100%);
      border-image-slice: 1;
      box-shadow: inset 0 0 0 1px rgba(1, 10, 19, 0.6);
    }

    /* Purple/Cyan border on hover for all skins (matching Aurelia theme) */
